        ...
        for (int i = 0; i < mTabs.size(); i++) {
            ...
            if (tab.fragment != null && !tab.fragment.isDetached()) {
                if (tab.tag.equals(currentTab)) {
                    ...
                    //++sky change detach to hide method
        ...
        if (mLastTab != newTab) {
            ...
            if (mLastTab != null) {
                if (mLastTab.fragment != null) {
                    // ++sky use hide replace detach for save fragment state
...
//                    ft.hide(mLastTab.fragment);
            ...
            } else if (newTab != null && newTab.fragment != null) {
                //++sky use show replace attach for save fragment state
